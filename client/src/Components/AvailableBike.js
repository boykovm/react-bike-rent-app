...
class AvailableBike extends Component {
    constructor(props) {
        super();
        ...
        return (
            <div className="mt-3 d-flex flex-row justify-content-between container-fluid py-2 px-4 bg-white border rented-bikes">
                ...
                <div className="col-2 mx-0 px-1 d-flex flex-column-reverse">
                    <button
                        className="btn bg-primary rounded-1 px-0 py-1"
                        onClick={() => rentBike(_id)}
                    >
                        <h6 className="pb-0 my-auto text-white">Rent</h6>
                    </button>
                </div>
                ...
                <div className="col-2 mx-0 px-1 d-flex flex-column-reverse">
                    <button
                        ...
                        onClick={() => deleteBike(_id)}
                    >
                        <h6 className="pb-0 my-auto text-white">Delete</h6>
                    </button>
                </div>
            </div>
        )
